...
export default function App({ Component, pageProps }) {
  ...
  const title = "Portfolio | Eki Wandana Putra";
  const description =
    "Hello! I'm Eki Wandana Putra, a passionate web developer. Welcome to my portfolio";
  const avatar =
  ...
  const url = "https://ekiwandanaputra-portfolio.vercel.app/";
